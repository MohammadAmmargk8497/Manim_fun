...
class MatrixMultiplication(Scene):
    def construct(self):
        ...
        self.wait(2)
        self.play(ReplacementTransform(grid_A, grid_result), ReplacementTransform(grid_B, grid_result))
        self.wait(2)
    ...
    def draw_grid(self, matrix, rows, cols, cell_size, font_size):
        ...
        for i in range(rows):
            for j in range(cols):
                ...
                square = Square(side_length=cell_size, fill_opacity=0, stroke_width=2)
